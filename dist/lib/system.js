...
exports.sanitizeUserRoomIntents = exports.sanitizeUserIntents = void 0;
...
function sanitizeIntent(name, intent) {
    const result = {};
    for (const field of Object.values(intents[name])) {
...
exports.sanitizeUserIntents = sanitizeUserIntents;
function sanitizeUserRoomIntents(input, result, groupingField = 'roomName') {
    for (const name in intents) {
        if (input[name]) {
...
exports.sanitizeUserRoomIntents = sanitizeUserRoomIntents;
